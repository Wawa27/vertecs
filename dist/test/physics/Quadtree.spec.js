...
describe("Quadtree", () => {
    describe("addEntity", () => {
        it("should add an entity within bounds", () => {
            const bounds = new AxisAlignedBoundingBox(vec3.fromValues(0, 0, 0), vec3.fromValues(100, 100, 100));
    ...
    describe("removeEntity", () => {
        it("should remove an entity", () => {
            const quadtree = new Quadtree(new AxisAlignedBoundingBox(vec3.fromValues(0, 0, 0), vec3.fromValues(100, 100, 100)));
