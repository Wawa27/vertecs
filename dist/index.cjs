...
var tsGlMatrix = require('ts-gl-matrix');
...
var CSS3DRenderer_js = require('three/addons/renderers/CSS3DRenderer.js');
var ws = require('ws');
...
class ThreeCamera extends Component {
    ...
    constructor(camera, lookAt, lookAtOffset, id, update) {
        ...
        this.#camera = camera;
        this.#lookAt = lookAt;
        this.#lookAtOffset = lookAtOffset || new tsGlMatrix.Vec3();
...
class ThreeObject3D extends Component {
    ...
    clone() {
        ...
        const clonedMesh = SkeletonUtils__namespace.clone(mesh);
        const { material } = mesh;
...
class Transform extends Component {
    ...
    constructor(translation, rotation, scaling, forward) {
        super();
        this.modelMatrix = tsGlMatrix.Mat4.create();
        this.modelToWorldMatrix = tsGlMatrix.Mat4.create();
        this.worldToModelMatrix = tsGlMatrix.Mat4.create();
        this.position = tsGlMatrix.Vec3.create();
        this.rotation = tsGlMatrix.Quat.create();
        this.scaling = tsGlMatrix.Vec3.fromValues(1, 1, 1);
        this.forward = forward ?? tsGlMatrix.Vec3.fromValues(0, 0, 1);
        this.#worldPosition = tsGlMatrix.Vec3.create();
        this.#worldRotation = tsGlMatrix.Quat.create();
        this.#worldScale = tsGlMatrix.Vec3.create();
        if (translation)
            tsGlMatrix.Vec3.copy(this.position, translation);
        if (rotation)
            tsGlMatrix.Quat.copy(this.rotation, rotation);
        if (scaling)
            tsGlMatrix.Vec3.copy(this.scaling, scaling);
        this.dirty = true;
    }
    /**
     ...
     */
    copy(transform) {
        tsGlMatrix.Mat4.getTranslation(this.position, transform);
        tsGlMatrix.Mat4.getRotation(this.rotation, transform);
        tsGlMatrix.Mat4.getScaling(this.scaling, transform);
        this.dirty = true;
    }
    /**
    ...
    translate(translation) {
        tsGlMatrix.Vec3.add(this.position, this.position, translation);
        this.dirty = true;
    }
    setWorldRotation(rotation) {
        const inverseWorldRotation = tsGlMatrix.Quat.invert(tsGlMatrix.Quat.create(), this.getWorldRotation());
        tsGlMatrix.Quat.multiply(this.rotation, this.rotation, inverseWorldRotation);
        tsGlMatrix.Quat.mul(this.rotation, this.rotation, rotation);
        this.dirty = true;
    }
    /**
     ...
     */
    reset() {
        tsGlMatrix.Vec3.set(this.position, 0, 0, 0);
        this.resetRotation();
        tsGlMatrix.Vec3.set(this.scaling, 1, 1, 1);
        this.dirty = true;
    }
    /**
     ...
     */
    resetRotation() {
        tsGlMatrix.Quat.set(this.rotation, 0, 0, 0, 1);
        this.dirty = true;
    }
    /**
     ...
     */
    rotateX(x) {
        tsGlMatrix.Quat.rotateX(this.rotation, this.rotation, x);
        this.dirty = true;
    }
    /**
     ...
     */
    rotateY(y) {
        tsGlMatrix.Quat.rotateY(this.rotation, this.rotation, y);
        this.dirty = true;
    }
    /**
     * Rotate this transform in the y axis
     ...
     */
    rotateZ(z) {
        tsGlMatrix.Quat.rotateZ(this.rotation, this.rotation, z);
        this.dirty = true;
    }
    rotate(rotation) {
        tsGlMatrix.Quat.mul(this.rotation, this.rotation, rotation);
    ...
    setWorldScale(scale) {
        const inverseScale = tsGlMatrix.Vec3.inverse(tsGlMatrix.Vec3.create(), this.getWorldScale());
        tsGlMatrix.Vec3.mul(this.scaling, this.scaling, inverseScale);
        tsGlMatrix.Vec3.mul(this.scaling, this.scaling, scale);
        this.dirty = true;
    }
    scale(scale) {
        tsGlMatrix.Vec3.multiply(this.scaling, this.scaling, scale);
        this.dirty = true;
    }
    setScale(scale) {
        tsGlMatrix.Vec3.copy(this.scaling, scale);
        this.dirty = true;
    }
    ...
    updateModelToWorldMatrix() {
        ...
        tsGlMatrix.Mat4.fromRotationTranslationScale(this.modelMatrix, this.rotation, this.position, this.scaling);
        // If the object has a parent, multiply its matrix with the parent's
        if (this.parent) {
            const parentMatrix = this.parent.updateModelToWorldMatrix();
            tsGlMatrix.Mat4.mul(this.modelToWorldMatrix, parentMatrix, this.modelMatrix);
        }
        else {
            tsGlMatrix.Mat4.copy(this.modelToWorldMatrix, this.modelMatrix);
        }
        tsGlMatrix.Mat4.getTranslation(this.#worldPosition, this.modelToWorldMatrix);
        tsGlMatrix.Mat4.getRotation(this.#worldRotation, this.modelToWorldMatrix);
        tsGlMatrix.Mat4.getScaling(this.#worldScale, this.modelToWorldMatrix);
        return this.modelToWorldMatrix;
    }
    getWorldToModelMatrix() {
        return tsGlMatrix.Mat4.invert(this.worldToModelMatrix, this.updateModelToWorldMatrix());
    }
    getWorldPosition() {
        if (this.dirty) {
    ...
    getWorldForwardVector(out) {
        ...
        tsGlMatrix.Vec3.normalize(out, tsGlMatrix.Vec3.transformQuat(tsGlMatrix.Vec3.create(), this.forward, worldRotation));
        return out;
    }
    getVectorInModelSpace(out, vector) {
        this.updateModelToWorldMatrix();
        tsGlMatrix.Mat4.invert(this.worldToModelMatrix, this.modelToWorldMatrix);
        tsGlMatrix.Vec3.transformMat4(out, vector, this.worldToModelMatrix);
        return out;
    }
    getVectorInWorldSpace(out, vector) {
        tsGlMatrix.Vec3.transformMat4(out, vector, this.updateModelToWorldMatrix());
        return out;
    }
    toWorldScale(out, scale) {
        tsGlMatrix.Vec3.mul(out, scale, tsGlMatrix.Vec3.inverse(tsGlMatrix.Vec3.create(), this.getWorldScale()));
        return out;
    }
    /**
     ...
     */
    lookAtXyz(x, y, z) {
        const lookAtMatrix = tsGlMatrix.Mat4.create();
        tsGlMatrix.mat4.targetTo(lookAtMatrix, [x, y, z], this.getWorldPosition(), [0, 1, 0]);
        tsGlMatrix.Mat4.getRotation(this.rotation, lookAtMatrix);
        this.dirty = true;
    }
    lookAt(position) {
    ...
    setWorldUnitScale() {
        ...
        const scale = tsGlMatrix.Vec3.create(); // TODO: Cache this
        const currentScale = tsGlMatrix.Vec3.create(); // TODO: Cache this
        tsGlMatrix.Vec3.div(scale, [1, 1, 1], tsGlMatrix.Mat4.getScaling(currentScale, modelToWorldMatrix));
        this.scale(scale);
    }
    setWorldPosition(position) {
        const worldPosition = this.getWorldPosition();
        tsGlMatrix.Vec3.sub(position, position, worldPosition);
        tsGlMatrix.Vec3.add(this.position, this.position, position);
        this.dirty = true;
    }
    /**
    ...
    setPosition(position) {
        tsGlMatrix.Vec3.copy(this.position, position);
        this.dirty = true;
    }
    setForward(forward) {
        tsGlMatrix.Vec3.copy(this.forward, forward);
        this.dirty = true;
    }
    /**
...
class MathUtils {
    ...
    static getEulerFromQuat(out, quat) {
        ...
        tsGlMatrix.vec3.set(out, MathUtils.getEulerToDegrees(roll), MathUtils.getEulerToDegrees(pitch), MathUtils.getEulerToDegrees(yaw));
        return out;
    }
}
...
class ThreeCameraSystem extends System {
    ...
    async onStart() {
        ...
        this.cameraEntity?.addComponent(new ThreeCamera(new three.Camera(), originEntity));
    ...
    onEntityEligible(entity, components) {
        ...
        if (cameraComponent.orbitControls) {
            this.#controls = new OrbitControls_js.OrbitControls(cameraComponent.camera, this.#renderer.domElement);
        }
    ...
    onLoop(components, entities, deltaTime) {
        ...
        camera.rotation.setFromQuaternion(new three.Quaternion(worldRotation[0], worldRotation[1], worldRotation[2], worldRotation[3]));
        if (lookAtTransform) {
...
class ThreeCss3dComponent extends Component {
    ...
    constructor(htmlElement, id) {
        ...
        this.#css3dObject = new CSS3DRenderer_js.CSS3DObject(htmlElement);
    }
    get css3dObject() {
...
class ThreeCss3dSystem extends System {
    ...
    constructor(threeSystem, tps) {
        ...
        this.#renderer = new CSS3DRenderer_js.CSS3DRenderer();
...
class ThreeInstancedMesh extends ThreeObject3D {
    ...
    clone() {
        if (this.entities.length > 1024) {
            return new ThreeInstancedMesh(new three.InstancedMesh(super.object3D.geometry, super.object3D.material, this.entities.length), this.id);
        }
        return this;
    }
}
...
class ThreeSystem extends System {
    ...
    onEntityEligible(entity, components) {
        ...
        if (threeMesh instanceof ThreeInstancedMesh) {
            ...
            for (let i = 0; i < instancedMesh.count; i++) {
                ...
                matrix.compose(new three.Vector3(0, 0, 0), new three.Quaternion(0, 0, 0, 1), new three.Vector3(0, 0, 0));
    ...
    onLoop(components, entities, deltaTime) {
        ...
        const scaleVector3 = new three.Vector3();
...
class ThreeAnimation extends Component {
    ...
    createMixer(meshComponent) {
        this.#mixer = new three.AnimationMixer(meshComponent.object3D);
...
class FiniteStateMachineSystem extends System {
    constructor(tps) {
 ...
 */
class NetworkEntity extends SerializedEntity {
 ...
 */
class NetworkComponent extends SerializableComponent {
    $updateTimestamp;
    $forceUpdate;
    #lastData;
    #ownerId;
 ...
 */
class IsNetworked extends NetworkComponent {
    #parent;
    constructor(ownerId, scope) {
        super(ownerId, scope);
    }
...
class NetworkSystem extends System {
    ...
    isOutOfSync(snapshot, entity, component) {
        ...
        this.#previousSnapshots.find((snapshot) => snapshot.timestamp < component.updateTimestamp);
        return true;
    }
 ...
 */
class ServerNetworkSystem extends NetworkSystem {
    #webSocketServer;
    $clientHandlers;
 ...
 */
class ClientNetworkSystem extends NetworkSystem {
    #webSocket;
    $serverSnapshot;
    #address;
    #connected;
 ...
 * Represents an animation being played on an entity
 */
class NetworkAnimation extends NetworkComponent {
    constructor() {
        super();
    }
    accept(data) {
...
class NetworkFiniteStateMachine extends NetworkComponent {
    constructor() {
        super();
    }
    accept(stateName) {
...
class TimedStateSystem extends System {
    constructor() {
...
class ThreeAnimationSystem extends System {
    constructor(tps) {
...
class ThreeComponentDebugger extends Component {
    constructor() {
        super();
    }
    onAddedToEntity(entity) {
        ...
        const transform = entity.getComponent(Transform);
        forwardLineEntity.addComponent(new Transform(transform?.getVectorInModelSpace(tsGlMatrix.vec3.create(), [0, 100, 0]), undefined, transform?.toWorldScale(tsGlMatrix.vec3.create(), [1, 1, 1])));
        entity.addChild(forwardLineEntity);
    }
}

class AnimatedState extends TimedState {
    #name;
 ...
 */
class AnimatedStateSystem extends System {
    constructor() {
...
class OimoComponent extends Component {
    #bodyOptions;
    #body;
...
function Particle$1( config, normal ) {
...
Particle$1.prototype = Object.assign( Object.create( Shape.prototype ), {

    constructor: Particle$1,
...
// @ts-ignore
class OimoSystem extends System {
    #world;
    constructor(tps) {
    ...
    onEntityEligible(entity, components) {
        ...
        const worldRotation = MathUtils.getEulerFromQuat(tsGlMatrix.vec3.create(), transform?.getWorldRotation() ?? tsGlMatrix.quat.create());
    ...
    onLoop(components, entities, deltaTime) {
        ...
        for (let i = 0; i < components.length; i++) {
            ...
            if (oimoComponent.bodyOptions.disableRotation) {
                ...
                transform.setRotationQuat(tsGlMatrix.quat.fromValues(oimoComponent.body.getQuaternion().x, oimoComponent.body.getQuaternion().y, oimoComponent.body.getQuaternion().z, oimoComponent.body.getQuaternion().w));
            }
        }
    }
}
...
class Body extends SerializableComponent {
    $movable;
    $boundingBox;
    $mass;
    constructor(bodyOptions) {
        ...
        this.$boundingBox = new AxisAlignedBoundingBox(tsGlMatrix.vec3.create(), tsGlMatrix.vec3.create());
        this.$mass = bodyOptions?.mass ?? 0;
    }
    hasMoved() {
        const boundingBox = this.getBoundingBox();
        if (!tsGlMatrix.vec3.equals(this.$boundingBox.minimum, boundingBox.minimum) ||
            !tsGlMatrix.vec3.equals(this.$boundingBox.maximum, boundingBox.maximum)) {
...
class DefaultNarrowphase {
    constructor() { }
    getSphereSphereCollision(sphere1Position, sphere1Shape, sphere2Position, sphere2Shape) {
        const distance = tsGlMatrix.vec3.distance(sphere1Position, sphere2Position);
        const sumOfRadii = sphere1Shape.radius + sphere2Shape.radius;
        if (distance > sumOfRadii) {
            return undefined;
        }
        const contactNormal = new tsGlMatrix.Vec3();
        tsGlMatrix.vec3.subtract(contactNormal, sphere1Position, sphere2Position);
        tsGlMatrix.vec3.normalize(contactNormal, contactNormal);
        tsGlMatrix.vec3.scale(contactNormal, contactNormal, sumOfRadii - distance);
...
class DefaultSolver {
    solve(entity1, entity2, contactNormal) {
        ...
        entity2Transform.translate(tsGlMatrix.vec3.negate(tsGlMatrix.vec3.create(), contactNormal));
    }
    clone() {
...
class SphereBody extends Body {
    ...
    getBoundingBox() {
        ...
        return new AxisAlignedBoundingBox(tsGlMatrix.vec3.fromValues(position[0] - this.#radius, position[1] - this.#radius, position[2] - this.#radius), tsGlMatrix.vec3.fromValues(position[0] + this.#radius, position[1] + this.#radius, position[2] + this.#radius));
    }
    get radius() {
        return this.#radius;
    }
...
class PhysicsSystem extends System {
    ...
    findEntitiesFromRaycast(ray) {
        ...
        return result.sort((a, b) => {
            ...
            const aDistance = tsGlMatrix.vec3.distance(ray.origin, aTransform.getWorldPosition());
            const bDistance = tsGlMatrix.vec3.distance(ray.origin, bTransform.getWorldPosition());
...
class Ray {
    ...
    getSphereIntersection(sphereEntity) {
        ...
        const a = tsGlMatrix.vec3.dot(this.#direction, this.#direction);
        const b = 2 *
            tsGlMatrix.vec3.dot(tsGlMatrix.vec3.subtract(tsGlMatrix.vec3.create(), this.#origin, sphereWorldPosition), this.#direction);
        const c = tsGlMatrix.vec3.dot(tsGlMatrix.vec3.subtract(tsGlMatrix.vec3.create(), this.#origin, sphereWorldPosition), tsGlMatrix.vec3.subtract(tsGlMatrix.vec3.create(), this.#origin, sphereWorldPosition)) -
            radius ** 2;
        ...
        return tsGlMatrix.vec3.add(tsGlMatrix.vec3.create(), this.#origin, tsGlMatrix.vec3.scale(tsGlMatrix.vec3.create(), this.#direction, Math.min(t1, t2)));
    }
    get origin() {
        return this.#origin;
    }
...
class BodyDebugger extends Component {
    constructor() {
        super();
    }
    onAddedToEntity(entity) {
        ...
        tsGlMatrix.vec3.subtract(tsGlMatrix.vec3.create(), boundingBox?.maximum || [0, 0, 0], boundingBox?.minimum || [0, 0, 0]);
        boundingBoxDebugEntity.addComponent(new ThreeObject3D(new three.Mesh(new three.SphereGeometry(sphereBody?.radius || 1, 32, 32), new three.MeshBasicMaterial({ color: 0xff0000 }))));
        const inverseScale = tsGlMatrix.vec3.create();
        tsGlMatrix.vec3.inverse(inverseScale, entity.getComponent(Transform)?.getWorldScale() || [1, 1, 1]);
        boundingBoxDebugEntity.addComponent(new Transform(undefined, undefined, inverseScale));
...
let NetworkSphereBody$1 = class NetworkSphereBody extends NetworkComponent {
    constructor() {
        super();
    }
    onAddedToEntity(entity) {
...
class CubeBody extends Body {
    ...
    getBoundingBox() {
        ...
        return new AxisAlignedBoundingBox(tsGlMatrix.vec3.fromValues(position[0] - this.#width / 2, position[1] - this.#height / 2, position[2] - this.#depth / 2), tsGlMatrix.vec3.fromValues(position[0] + this.#width / 2, position[1] + this.#height / 2, position[2] + this.#depth / 2));
    }
    read(data) { }
    write() {
        return {
...
class NetworkSphereBody extends NetworkComponent {
    constructor() {
        super();
    }
    onAddedToEntity(entity) {
...
class Particle extends Component {
    ...
    clone() {
        return new Particle({
            ...
            timeAlive: 0,
            startColor: new tsGlMatrix.Vec3(this.startColor),
            endColor: new tsGlMatrix.Vec3(this.endColor),
        });
    }
}
    ...
    onLoop(components, entities, deltaTime) {
        for (let i = components.length - 1; i >= 0; i--) {
            ...
            if (particle.timeAlive >= particle.lifeTime) {
                ...
                transform.setWorldScale(new tsGlMatrix.Vec3(particle.startScale +
                    (particle.endScale - particle.startScale) *
                        (particle.timeAlive / particle.lifeTime)));
                const worldPosition = new tsGlMatrix.Vec3(transform.getWorldPosition());
                worldPosition.add([
...
exports.AnimatedState = AnimatedState;
exports.AnimatedStateSystem = AnimatedStateSystem;
...
exports.ClientNetworkSystem = ClientNetworkSystem;
exports.Collision = Collision;
exports.Component = Component;
exports.DefaultNarrowphase = DefaultNarrowphase;
exports.DefaultSolver = DefaultSolver;
exports.EcsManager = EcsManager;
exports.Entity = Entity;
exports.FiniteStateMachine = FiniteStateMachine;
exports.FiniteStateMachineSystem = FiniteStateMachineSystem;
exports.IoUtils = IoUtils;
exports.IsNetworked = IsNetworked;
exports.IsPrefab = IsPrefab;
exports.KeyboardInputSystem = KeyboardInputSystem;
exports.MathUtils = MathUtils;
exports.MouseInputSystem = MouseInputSystem;
exports.NetworkAnimation = NetworkAnimation;
exports.NetworkComponent = NetworkComponent;
exports.NetworkCubeBody = NetworkSphereBody;
exports.NetworkFiniteStateMachine = NetworkFiniteStateMachine;
exports.NetworkSphereBody = NetworkSphereBody$1;
exports.NetworkTransform = NetworkTransform;
exports.OimoComponent = OimoComponent;
...
exports.ServerNetworkSystem = ServerNetworkSystem;
exports.Sound = Sound;
exports.SoundSystem = SoundSystem;
exports.SphereBody = SphereBody;
exports.State = State;
exports.StateSystem = StateSystem;
exports.System = System;
exports.ThreeAnimation = ThreeAnimation;
exports.ThreeAnimationSystem = ThreeAnimationSystem;
exports.ThreeCamera = ThreeCamera;
exports.ThreeCameraSystem = ThreeCameraSystem;
exports.ThreeComponentDebugger = ThreeComponentDebugger;
exports.ThreeCss3dComponent = ThreeCss3dComponent;
exports.ThreeCss3dSystem = ThreeCss3dSystem;
exports.ThreeInstancedMesh = ThreeInstancedMesh;
exports.ThreeLightComponent = ThreeLightComponent;
exports.ThreeLightSystem = ThreeLightSystem;
exports.ThreeObject3D = ThreeObject3D;
exports.ThreeSystem = ThreeSystem;
exports.TimedState = TimedState;
exports.TimedStateSystem = TimedStateSystem;
